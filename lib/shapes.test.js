...
describe("Shapes", () => {
    ...
    describe("Triangle", () => {
        it("Should return a string for the Triangle SVG file with the given shape color.", () => {
            ...
            expect(shape1.render()).toEqual(`<svg><polygon points="150, 18 244, 182 56, 182" fill="blue" /></svg>`);
        })
    })
    ...
    describe("Circle", () => {
        it("Should return a string for the Triangle SVG file with the given shape color.", () => {
            ...
            expect(shape2.render()).toEqual(`<svg><circle cx="150" cy="100" r="80" fill="blue" /></svg>`);
        })
    })
    ...
    describe("Square", () => {
        it("Should return a string for the Triangle SVG file with the given shape color.", () => {
            ...
            expect(shape3.render()).toEqual(`<svg><rect x="90" y="40" width="120" height="120" fill="blue" /></svg>`);
        })
    })
});